...
# yolov8s 模型系列训练
echo -e "\n================================================================="
echo "🌟🌟🌟 开始 yolov8s 模型系列训练 🌟🌟🌟"
echo "================================================================="

# run_training_task "yolov8s.yaml" "paint/_paint_16col1.yaml"
# run_training_task "yolov8s.yaml" "paint/_paint_16row1.yaml"
# run_training_task "yolov8s.yaml" "paint/_paint_32col1.yaml"
# run_training_task "yolov8s.yaml" "paint/_paint_32row1.yaml"
# run_training_task "yolov8s.yaml" "paint/_paint_grid.yaml"
# run_training_task "yolov8s.yaml" "paint/_paint_white.yaml"

# yolov12s 模型系列训练
echo -e "\n================================================================="
echo "🌟🌟🌟 开始 yolov12s 模型系列训练 🌟🌟🌟"
echo "================================================================="

run_training_task "yolo12s.yaml" "paint/_paint_16col1.yaml"
run_training_task "yolo12s.yaml" "paint/_paint_16row1.yaml"
run_training_task "yolo12s.yaml" "paint/_paint_32col1.yaml"
run_training_task "yolo12s.yaml" "paint/_paint_32row1.yaml"
run_training_task "yolo12s.yaml" "paint/_paint_grid.yaml"
run_training_task "yolo12s.yaml" "paint/_paint_white.yaml"
